var _initClass, _classDecs, _initProto, _initClass2, _classDecs2, _dec, _initProto2, _initClass3, _classDecs3, _dec2, _init_citiesDB, _dec3;
...
_classDecs = [Injectable('CitiesDB')];
let _CitiesDB;
class CitiesDB {
  static {
    [_CitiesDB, _initClass] = _applyDecs(this, [], _classDecs).c;
  }
  getCities() {
...
class WeatherController {
  static {
    ({
      e: [_initProto],
      c: [_WeatherController, _initClass2]
    } = _applyDecs(this, [[_dec, 2, "getForecast"]], _classDecs2));
  }
  constructor() {
    _initProto(this);
  }
...
_classDecs3 = [Controller('/api')];
_dec2 = Inject('CitiesDB');
_dec3 = Get('/cities');
let _CitiesController;
class CitiesController {
  static {
    ({
      e: [_init_citiesDB, _initProto2],
      c: [_CitiesController, _initClass3]
    } = _applyDecs(this, [[_dec3, 2, "getCities"], [_dec2, 0, "citiesDB"]], _classDecs3));
  }
  citiesDB = (_initProto2(this), _init_citiesDB(this));
  getCities() {
    return {
